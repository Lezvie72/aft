...
@Name("RFQ Outgoing Multiple Offer Item")
@FindBy(css = "atm-rfq-item-outgoing-offers atm-rfq-item-outgoing-offer")
class RFQOutgoingMultipleOfferItem : BaseBlock<AtmPage>() {
