...
object Constants {
    ...
    const val ATM_USER_OTF_TVE_MANAGER_ROLE = "ATM_USER_OTF_TVE_MANAGER_ROLE"
    const val ATM_USER_VIEWER_ROLE = "ATM_USER_VIEWER_ROLE"
    const val ATM_USER_FINANCE_MANAGER_ROLE = "ATM_USER_FINANCE_MANAGER_ROLE"
    const val ATM_USER_PLATFORM_ADMINISTRATOR_ROLE = "ATM_USER_PLATFORM_ADMINISTRATOR_ROLE"
    const val ATM_USER_ISSUER_ROLE = "ATM_USER_ISSUER_ROLE"
    const val ATM_USER_VALIDATOR_ROLE = "ATM_USER_VALIDATOR_ROLE"
    const val ATM_USER_SUPER_ADMIN_ROLE = "ATM_USER_SUPER_ADMIN_ROLE"
    const val AML_KYC_MANAGER_ROLE = "AML_KYC_MANAGER_ROLE"
    const val PLATFORM_ADMIN_ROLE = "PLATFORM_ADMIN_ROLE"
    const val ATM_USER_GENERIC_PARTICIPANT_MANAGER_ROLE = "ATM_USER_GENERIC_PARTICIPANT_MANAGER_ROLE"
    const val ATM_USER_GENERIC_PARTICIPANT_ADMIN_ROLE = "ATM_USER_GENERIC_PARTICIPANT_ADMIN_ROLE"
