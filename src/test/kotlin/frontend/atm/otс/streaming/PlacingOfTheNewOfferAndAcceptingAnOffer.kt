...
class PlacingOfTheNewOfferAndAcceptingAnOffer : BaseTest() {
    companion object {
    ...
    fun offerPlacingCheckingTheFeeInBaseAssetFixed() {
        ...
        MatcherAssert.assertThat(
            "The Available value of ${quoteAsset.tokenSymbol} is decreased by $amountBuy * $unitPriceOffer",
        ...
        MatcherAssert.assertThat(
            "The Held in orders value of ${quoteAsset.tokenSymbol} is increased by $amountBuy * $unitPriceOffer",
        ...
        MatcherAssert.assertThat(
            "The Available value of ${baseAsset.tokenSymbol} is decreased by $amountBuy + $feeSize",
        ...
        MatcherAssert.assertThat(
            "The Held in orders value of ${baseAsset.tokenSymbol} is increased by $amountBuy + $feeSize",
    ...
    fun acceptOfferCheckingTheFeeInBaseAssetFixed() {
        ...
        MatcherAssert.assertThat(
            "The Available value of ${quoteAsset.tokenSymbol} is increased by $amountBuy * $unitPriceOffer",
        ...
        MatcherAssert.assertThat(
            "The Available value of ${baseAsset.tokenSymbol} is increased",
        ...
        MatcherAssert.assertThat(
            "The Available value of ${quoteAsset.tokenSymbol} is not changed",
        ...
        MatcherAssert.assertThat(
            "The Held in offers value of ${quoteAsset.tokenSymbol} is decreased",
        ...
        MatcherAssert.assertThat(
            "The Available value of ${baseAsset.tokenSymbol} is increased by $amountBuy - $feeSize",
            balanceStateUserTwo.afterBalanceBaseAsset.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
        ...
        MatcherAssert.assertThat(
            "The Available value of ${baseAsset.tokenSymbol} not changed",
            balanceStateUserOne.initBalanceBaseAsset.toDouble() == "%.8f".format(
                Locale.US,
                balanceStateUserOne.afterBalanceBaseAsset.toDouble()
            ).toDouble()
        ...
        MatcherAssert.assertThat(
            "The Held in offers value of ${baseAsset.tokenSymbol} is decreased",
        ...
        MatcherAssert.assertThat(
            "The Available value of ${quoteAsset.tokenSymbol} is increased",
            balanceStateUserOne.initBalanceQuoteAsset.toDouble() < "%.8f".format(
                Locale.US,
                balanceStateUserOne.afterBalanceQuoteAsset.toDouble()
            ).toDouble()
    ...
    fun offerPlacingCheckingTheFeeInQuoteAssetFixed() {
        ...
        MatcherAssert.assertThat(
            "The Available value of $${quoteAsset.tokenSymbol} is decreased by $amountBuy * $unitPriceOffer + $feeSize",
            balanceStateUserOne.afterBalanceQuoteAsset.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
        ...
        MatcherAssert.assertThat(
            "The Held in orders value of $${quoteAsset.tokenSymbol} is increased by $amountBuy * $unitPriceOffer + $feeSize",
            balanceStateUserOne.afterBalanceQuoteAssetHeld.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
        ...
        MatcherAssert.assertThat(
            "The Available value of ${baseAsset.tokenSymbol} is decreased by $amountBuy",
            balanceStateUserOne.afterBalanceBaseAsset.toDouble(),
            Matchers.equalTo(
        ...
        MatcherAssert.assertThat(
            "The Held in orders value of ${baseAsset.tokenSymbol} is increased by $amountBuy",
            balanceStateUserOne.afterBalanceBaseAssetHeld.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
    ...
    fun acceptOfferCheckingTheFeeInQuoteAssetFixed() {
        ...
        MatcherAssert.assertThat(
            "The Available value of ${quoteAsset.tokenSymbol} is increased by $amountBuy * $unitPriceOffer - $feeSize",
            balanceStateUserTwo.afterBalanceQuoteAsset.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
        ...
        updateAfterBalance(balanceStateUserTwo, userTwo)
        MatcherAssert.assertThat(
            "The Available value of ${baseAsset.tokenSymbol} is increased by $amountBuy",
            balanceStateUserTwo.afterBalanceBaseAsset.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
    ...
    fun offerPlacingCheckingTheFeeInTheThirdAssetFixed() {
        ...
        with(openPage<AtmStreamingPage>(driver)) {
            e {
                ...
                MatcherAssert.assertThat(
                    "Amount to send ${quoteAsset.tokenSymbol} should be $amountBuy * $unitPriceOffer",
                    amountToSend.amount.toDouble(),
                    Matchers.equalTo(
                        "%.8f".format(Locale.US, amountBuy.toDouble() * unitPriceOffer.toDouble()).toDouble()
                    )
        ...
        with(openPage<AtmStreamingPage>(driver) { submit(userOne) }) {
            e {
                ...
                MatcherAssert.assertThat(
                    "Amount to send ${baseAsset.tokenSymbol} should be $amountBuy",
                    amountToSend.amount.toDouble(),
                    Matchers.equalTo("%.8f".format(Locale.US, amountBuy.toDouble()).toDouble())
                )
                MatcherAssert.assertThat(
    ...
    fun acceptOfferCheckingTheFeeInTheThirdAssetFixed() {
        ...
        with(openPage<AtmStreamingPage>(driver)) {
            e {
                ...
                MatcherAssert.assertThat(
                    "Amount to receive ${baseAsset.tokenSymbol} should be $amountBuy",
                    amountToReceive.amount.toDouble(),
                    Matchers.equalTo("%.8f".format(Locale.US, amountBuy.toDouble()).toDouble())
                )
                MatcherAssert.assertThat(
        ...
        MatcherAssert.assertThat(
            "The Available value of ${baseAsset.tokenSymbol} is not changed",
            balanceStateUserOne.initBalanceBaseAsset.toDouble() == "%.8f".format(
                Locale.US,
                balanceStateUserOne.afterBalanceBaseAsset.toDouble()
            ).toDouble()
    ...
    fun offerPlacingCheckingTheFeeInBaseAssetVolume() {
        ...
        MatcherAssert.assertThat(
            "The Available value of ${baseAsset.tokenSymbol} is decreased by $amountBuy + $amountBuy * $feeSize",
            balanceStateUserOne.afterBalanceBaseAsset.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
        ...
        MatcherAssert.assertThat(
            "The Held in orders value of ${baseAsset.tokenSymbol} is increased by $amountBuy + $amountBuy * $feeSize",
            balanceStateUserOne.afterBalanceBaseAssetHeld.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
    ...
    fun acceptOfferCheckingTheFeeInBaseAssetVolume() {
        ...
        MatcherAssert.assertThat(
            "The Available value of ${baseAsset.tokenSymbol} is increased by $amountBuy - $amountBuy * $feeSize",
            balanceStateUserTwo.afterBalanceBaseAsset.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
    ...
    fun offerPlacingCheckingTheFeeInQuoteAssetVolume() {
        ...
        MatcherAssert.assertThat(
            "The Available value of ${quoteAsset.tokenSymbol} is decreased by $amountBuy * $unitPriceOffer + $amountBuy * $feeSize",
            balanceStateUserOne.afterBalanceQuoteAsset.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
        ...
        MatcherAssert.assertThat(
            "The Held in orders value of ${quoteAsset.tokenSymbol} is increased by $amountBuy * $unitPriceOffer + $amountBuy * $feeSize",
            balanceStateUserOne.afterBalanceQuoteAssetHeld.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
    ...
    fun acceptOfferCheckingTheFeeInQuoteAssetVolume() {
        ...
        MatcherAssert.assertThat(
            "The Available value of ${quoteAsset.tokenSymbol} is increased by $amountBuy * $unitPriceOffer - $amountBuy * $feeSize",
            balanceStateUserTwo.afterBalanceQuoteAsset.toDouble(),
            Matchers.equalTo(
                "%.8f".format(
                    Locale.US,
    ...
    fun acceptOfferCheckingTheFeeInTheThirdAssetVolume() {
        ...
        with(openPage<AtmStreamingPage>(driver)) {
            e {
                ...
                MatcherAssert.assertThat(
                    "Amount to receive ${quoteAsset.tokenSymbol} should be $amountBuy * $unitPriceOffer",
                    amountToReceive.amount.toDouble(),
                    Matchers.equalTo(
                        "%.8f".format(Locale.US, amountBuy.toDouble() * unitPriceOffer.toDouble()).toDouble()
                    )
    ...
    private fun setFilterBuyToday(
        ...
        elementActions.select(atmStreamingPage.tradingPair, "${baseAsset.tokenSymbol}/${quoteAsset.tokenSymbol}")
